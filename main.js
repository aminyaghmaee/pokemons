...
function addElements() {
  ...
  POKEMONS.forEach(function createElements(e) {
    ...
    pokeman.appendChild(imgDiv);
    // imgDiv.className = "img_div";
    imgDiv.appendChild(img);
    pokeman.appendChild(p);
    pokeman.appendChild(span);
    img.src = e.image;
    p.innerHTML = e.name;
    span.innerHTML = e.type;
    if (span.innerHTML == "water") {
      pokeman.style.backgroundColor = "blue";
    } else if (span.innerHTML == "fire") {
      pokeman.style.backgroundColor = "red";
    } else if (span.innerHTML == "grass") {
      pokeman.style.backgroundColor = "green";
    } else if (span.innerHTML == "bug") {
      pokeman.style.backgroundColor = "orange";
    } else if (span.innerHTML == "poison") {
      pokeman.style.backgroundColor = "yellow";
    } else if (span.innerHTML == "fairy") {
      pokeman.style.backgroundColor = "#21FFFF";
    } else if (span.innerHTML == "normal") {
      pokeman.style.backgroundColor = "#B2B217";
    } else if (span.innerHTML == "ground") {
      pokeman.style.backgroundColor = "#813C00";
    } else if (span.innerHTML == "electric") {
      pokeman.style.backgroundColor = "#810045";
    } else if (span.innerHTML == "rock") {
      pokeman.style.backgroundColor = "#A85610";
    } else if (span.innerHTML == "fighting") {
      pokeman.style.backgroundColor = "#D81C1C";
    } else if (span.innerHTML == "psychic") {
      pokeman.style.backgroundColor = "#FF21FF";
    } else if (span.innerHTML == "ghost") {
      pokeman.style.backgroundColor = "#FFFFD3";
    }
  });
  createElements();
}
